...
require_once __DIR__ . '/../Helper/Message.php';
/**
...
class Message {
	 ...
	 *
	 * @param string $to
	 *        	Number where we are sending message
	 * @param string $from
	 *        	Number we are sending from or text
	 * @param string $message
	 *        	Message we are sending
	 * @param string $connection
	 *        	Connection id to use for sending sms
	 * @param string $encoding
	 *        	Encoding of message UTF-8, ISO-8859-15 or Unicode
	 * @param array $options
	 *        	Array of additional options. More info on: http://api.beepsend.com/docs.html#send-sms
	 * @return array
	 */
	 ...
	 *        	Group where we are sending message, for multiple groups use array (number1, number2)
	 ...
	 *
	 * @param array $groups
	 *        	Group where we are sending message, OPTIONAL
	 * @param array $to
	 *        	list of numbers to send to, OPTIONAL
	 * @param string $from
	 *        	Number we are sending from or text
	 * @param string $message
	 *        	Message we are sending
	 ...
	 *        	Encoding of message UTF-8, ISO-8859-15 or Unicode
	 * @param array $options
	 *        	Array of additional options. More info on: http://api.beepsend.com/docs.html#sendouts
	 * @return array
	 */
	 ...
	 *
	 * @param string $to
	 *        	Number where we are sending message, for multiple recepiants use array (number1, number2)
	 * @param string $from
	 *        	Number we are sending from or text
	 * @param string $message
	 *        	Message we are sending
	 ...
	 *        	Encoding of message UTF-8, ISO-8859-15 or Unicode
	 * @param array $options
	 *        	Array of additional options. More info on: http://api.beepsend.com/docs.html#send-sms-binary
	 * @return array
	 */
	 ...
	 *
	 * @param array $options
	 *        	Array of options to fetch messages. More info on: http://api.beepsend.com/docs.html#sms-lookup-multiple
	 */
	 ...
	 *
	 * @param id|array $groups
	 *        	Single or multple groups
	 * @param string $message
	 *        	Message
	 * @param string $connection
	 *        	Connection id
